        ...
        return (
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <div>
                <p className="text-sm">Balance1</p>
            ...
            <div className="flex justify-between">
              ...
              <div className="flex">
                <div className="w-5 h-5 border-2 bg-gray-500 rounded-full ml-5"></div>
                <div className="w-5 h-5 border-2 bg-gray-500 rounded-full"></div>
              </div>
            </div>
          </div>
        );
